...
const Experience = () => {
  return (
    <StyledExperience id="experience">
      ...
      <section>
        <h5>
          Dependienta de retail
          <br />
          Guess - Adolfo Dominguez - Carolina Herrera - Nike
        </h5>
        <h5>2022 - 2024</h5>
        <h6>
      ...
      <span></span>
      <section>
        <h5>E-commerce manager | Roma by Rochi</h5>
        <h5>2021 - 2022</h5>
        <h6>
      ...
      <span></span>
      <section>
        <h5>Administrativa | Power System</h5>
        <h5>2017 - 2019</h5>
        <h6>
      ...
      <span></span>
      <section>
        <h5>Emprendimiento | Philipinos</h5>
        <h5>2016 - 2020</h5>
        <h6>
